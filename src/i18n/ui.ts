...
export const ui = {
    en: {
        ...
        "career.0.content.keywords": joinCommas(
            "Web S/W",
        ...
        skills: "Main Skills",
        "skills.40.label": "Programming",
        "skills.50.label": "Others",
    },
    ko: {
        toTop: "맨 위로",
        lastUpdated: "최근 업데이트:",
        ...
        "career.0.content.keywords": joinCommas("웹 S/W 개발", "팀 과제 관리"),
        "career.1.header": "2015.9 - 2018.7",
        ...
        "career.2.content.keywords": joinCommas("인사 업무", "훈련 센터"),
        experience: "경험",
